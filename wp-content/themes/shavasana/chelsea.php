...
get_header(); ?>
    ...
    <!-- =========================== | GLOBAL HERO WRAP | =========================== -->
    <section style="background: transparent url(<?php echo get_template_directory_uri(); ?>/img/blogHeaders/chelseyHeader.jpg) no-repeat;" class="gHeroWrap angelaHero fullWrap" id="indexVideo">
        <div>
            <h2>Chelsey Moss</h2>
            <p>After facing a life threatening disease, Chelsey found herself immersed
                in the practice of yoga.  She fell in love with every element of yoga; connecting
                breath with movement in a mindful meditation. Her health dramatically improved and her
                disease disappeared.   Chelsey’s classes are focused on creating heat within the
                body – to be with the fire of transformation, and see what is true.</p>
    ...
    <div class="gContent">
        ...
        <section class="blogWrap">
            ...
            <div class="blogRow">
                ...
                $args = array( 'posts_per_page' => 7, 'author' => 5 );
